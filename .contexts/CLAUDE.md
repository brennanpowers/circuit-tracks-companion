...
They prevent re-learning the same things every session and serve as a shared knowledge base.
...
- Created at Brennan's request, or proactively suggested when useful context is discovered
